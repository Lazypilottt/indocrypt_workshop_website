...
export default function Navbar() {
  ...
  return (
    <nav className="w-full bg-[#9ec5c6] border border-[#2e2a30]/20 shadow-lg rounded-[24px] mx-auto max-w-[95%] my-2">
      ...
      {/* Mobile Drawer */}
      {open && (
        <div className="md:hidden px-6 pb-5 text-[#2e2a30] text-base font-medium animate-slideDown bg-gradient-to-b from-[#9ec5c6] to-transparent">
          {[
            { label: 'Home', path: '/' },
            { label: 'Program', path: '/program' },
            { label: 'Registration', path: '/registration' },
