          ...
          <GlowingBox className="p-5 sm:p-8">
            <div className="space-y-4 text-[#2e2a30]/90 text-sm sm:text-base leading-relaxed text-justify">
              <p className="first-letter:text-3xl first-letter:font-bold">
                In a landmark collaboration, the <strong>Indian Institute of Technology Bhilai</strong> and the <strong>Cryptology Research Society of India (CRSI)</strong> are proud to present the <strong>National Workshop on Cryptology (NWC 2025)</strong>. As the flagship annual event of CRSI, this workshop serves as a premier national forum dedicated to uniting the brightest minds in cryptology and information security. The event is being organized by the <strong>Department of Computer Science and Engineering, IIT Bhilai</strong>, which is actively engaged in cutting-edge research in cybersecurity, cryptography, and related domains. IIT Bhilai, one of India’s newer IITs, is committed to fostering innovation, interdisciplinary collaboration, and excellence in research and education. Through NWC 2025, the institute aims to create a vibrant platform for researchers, academicians, students, and industry pioneers to engage in meaningful dialogue, share insights, and collectively advance the frontiers of digital security in India.
              </p>
              <p>
