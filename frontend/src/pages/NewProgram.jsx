...
const schedule = [
  ...
  [
    ...
    { time: '12:00 - 13:00', event: 'Talk 1 (contd.)', chair: 'Prof. Dipanwita Roy Chowdhury', type: 'misc' },
  ...
  [
    ...
    { time: '10:30 - 11:30', event: 'Talk 5: "Differential Cryptanalysis of ARMs Pointer Authentication Code" by Dr Shibam Ghosh', chair: 'Dr Sabyasachi Karati', type: 'talk' },
    { time: '11:30 - 12:00', event: 'Snacks & Tea', chair: '', type: 'snacks' },
    { time: '12:00 - 13:00', event: 'Talk 6: "Privacy in AI" by Nishant Chandran', chair: 'Dr Dhiman Saha', type: 'talk' },
    { time: '13:00 - 14:00', event: 'Lunch', chair: '', type: 'lunch' },
    ...
    { time: '15:00 - 15:30', event: 'IBITF Session', chair: 'Dr R Kabaleeshwaran', type: 'misc' },
    { time: '15:30 - 16:30', event: 'Poster Session', chair: '', type: 'misc' },
    { time: '16:30 - 17:00', event: 'Snacks & Tea', chair: '', type: 'snacks' },
    { time: '17:00 - 18:00', event: 'Talk 8: "Key Committing Attacks against AES-based AEAD Schemes" Dr Mostafizar Rahman', chair: 'Dr Subidh Ali', type: 'talk' },
  ],
  // Dec 09
  [
