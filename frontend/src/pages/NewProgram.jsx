...
const schedule = [
  ...
  [
    ...
    { time: '10:45 - 11:45', event: 'Talk 1: "Some Recent Issues in Cryptology" by Prof. Bimal Kumar Roy', chair: 'Dipanwita Roy Chowdhury', type: 'misc' },
    { time: '11:45 - 12:00', event: 'Snacks & Tea', chair: '', type: 'snacks' },
    { time: '12:00 - 13:00', event: 'Talk 1 (contd.)', chair: 'Dipanwita Roy Chowdhury', type: 'misc' },
    { time: '13:00 - 14:00', event: 'Lunch', chair: '', type: 'lunch' },
    { time: '14:00 - 15:00', event: 'Talk 2: Prof. Dipanwita Roy Chowdhury', chair: 'Prof. Souradyuti Paul ', type: 'misc' },
    { time: '15:00 - 15:15', event: 'Tea/Coffee', chair: '', type: 'snacks' },
    { time: '15:15 - 16:15', event: 'Talk 2 (contd.)', chair: 'Prof. Souradyuti Paul ', type: 'misc' },
  ...
  // Dec 08
  [
    { time: '09:30 - 10:30', event: 'Talk 4: "Zero Knowledge Proof and its Application" by Dr Avijit Dutta', chair: 'Sabyasachi Karati', type: 'talk' },
    { time: '10:30 - 11:30', event: 'Talk 5: "Differential Cryptanalysis of ARMs Pointer Authentication Code" by Dr Shibam Ghosh', chair: 'Sabyasachi Karati', type: 'talk' },
    { time: '11:30 - 12:00', event: 'Snacks & Tea', chair: '', type: 'snacks' },
    { time: '12:00 - 13:00', event: 'Talk 6: "Privacy in AI" by Nishant Chandran', chair: 'Dhiman Sir', type: 'talk' },
    { time: '13:00 - 14:00', event: 'Lunch', chair: '', type: 'lunch' },
    { time: '14:00 - 15:00', event: 'Talk 7: "Post-Quantum Digital Signatures from Hash Functions" by Dr Sabyasachi Karati', chair: 'R Kabaleeshwaran', type: 'talk' },
    { time: '15:00 - 15:30', event: 'IBITF Session', chair: 'R Kabaleeshwaran', type: 'misc' },
    { time: '15:30 - 16:30', event: 'Poster Session', chair: '', type: 'misc' },
    { time: '16:30 - 17:00', event: 'Snacks & Tea', chair: '', type: 'snacks' },
    { time: '17:00 - 18:00', event: 'Talk 8: "Key Committing Attacks against AES-based AEAD Schemes" Dr Mostafizar Rahman', chair: 'Subidh Ali', type: 'talk' },
  ],
  // Dec 09
  [
